...
public class Main {
    public static void main(String[] args) {
        PassportData passport = new PassportData( "1234", "567890", "Italy", LocalDate.of( 2024, 7, 3 ), "0000" );
        ContactInfo contact = new ContactInfo( "00393236142", "manas@mail.ru", "Italy,Milano, via Alto Adige 5", "Italy,Milano, via Alto Adige 5" );
        ...
        application.setName( "Manas" );
        application.setSurname( "Kim" );
        application.setBirthday( LocalDate.of( 2010, 8, 11 ) );
        ...
        System.out.println("-------------------------------------------------------------------------------------------");
        if (!application.isEligibleForCredit()) {
            System.out.println("Do not issue credit! You are too young to apply for credit!");
            return;
        }
    }
}
